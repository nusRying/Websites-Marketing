...
def create_initial_data():
    ...
    try:
        ...
        if not target_user:
            print(f"❌ User {user_email} not found in Auth. Please ensure you created it in the Supabase Dashboard.")
            return
        ...
        print("✅ Sample HOT Lead created. You will see a pulsing 'HOT' badge in the dashboard!")

        print("\n--- SETUP COMPLETE ---")
        print("Go to http://localhost:3000, log in, and enjoy your SaaS Command Center.")
