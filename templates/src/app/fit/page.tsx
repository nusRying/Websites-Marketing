'use client';
import { CheckCircle2, Star, ArrowRight, Dumbbell, Zap, Trophy, Timer, Users, Target, ShieldCheck, Flame } from 'lucide-react';
    ...
    <div className={styles.wrapper}>
      ...
      <section className={styles.hero}>
        ...
        <div style={{ position: 'relative', width: '100%', height: '400px', marginTop: '40px', borderRadius: '16px', overflow: 'hidden' }}>
          <Image src="https://images.unsplash.com/photo-1534438327276-14e5300c3a48?auto=format&fit=crop&w=1200&q=80" alt={`${niche} in ${location}`} fill style={{ objectFit: 'cover' }} priority />
        </div>
