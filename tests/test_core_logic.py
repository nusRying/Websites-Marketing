...
def test_excel_exporter_logic():
    ...
    mock_leads = [
        {"name": "Elite Plumbers", "rating": "4.9 (100 reviews)", "category": "Plumber", "url": "https://maps.google.com/1"}
    ]
...
def test_ai_enrichment_mock(mock_openai):
    ...
    mock_response.choices = [
        MagicMock(message=MagicMock(content='{"hero_title": "Test Title", "pain_point": "Test Pain"}'))
    ]
